...
> **使用说明**：本组件库为「公司红」主题（经典编辑风），所有组件使用**内联样式**，可直接复制粘贴到微信公众号编辑器。
>
...
<section style="margin:10px 10px 32px;background:#ffffff;border-radius:12px;box-shadow:0 4px 24px -4px rgba(220,38,38,0.15);padding:28px 24px 22px;overflow:hidden;">
  <p style="font-size:42px;color:#F03C16;font-weight:900;margin:0;line-height:0.6;">
    <span leaf="">"</span>
  </p>
  <p style="font-size:16px;font-weight:800;color:#1C1917;margin:12px 0 8px;line-height:1.75;padding-left:4px;">
    <span style="background:#F03C16;color:#FFFFFF;padding:2px 8px;border-radius:4px;"><span leaf="">{{高亮关键词}}</span></span>
    <span leaf="">{{金句中段}}</span>
    <span style="background:#F03C16;color:#FFFFFF;padding:2px 8px;border-radius:4px;"><span leaf="">{{高亮关键词}}</span></span>
    <span leaf="">{{金句收尾}}</span>
  </p>
...
<section style="padding:0 10px 32px;">
  ...
  <section style="display:flex;justify-content:space-between;">
    <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:16px 12px;margin-right:8px;text-align:center;border:1px solid #FDE5DF;">
      <p style="display:inline-block;background:#F03C16;color:#FFFFFF;font-size:12px;font-weight:800;padding:2px 10px;border-radius:4px;margin:0 0 8px;"><span leaf="">01</span></p>
      <p style="font-size:13px;font-weight:700;color:#1C1917;margin:0;"><span leaf="">{{看点一}}</span></p>
    </section>
    <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:16px 12px;margin-right:8px;text-align:center;border:1px solid #FDE5DF;">
      <p style="display:inline-block;background:#F03C16;color:#FFFFFF;font-size:12px;font-weight:800;padding:2px 10px;border-radius:4px;margin:0 0 8px;"><span leaf="">02</span></p>
      <p style="font-size:13px;font-weight:700;color:#1C1917;margin:0;"><span leaf="">{{看点二}}</span></p>
    </section>
    <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:16px 12px;text-align:center;border:1px solid #FDE5DF;">
      <p style="display:inline-block;background:#F03C16;color:#FFFFFF;font-size:12px;font-weight:800;padding:2px 10px;border-radius:4px;margin:0 0 8px;"><span leaf="">03</span></p>
...
<section style="padding:0 10px;">
  <section style="height:1px;background:linear-gradient(to right,transparent,#F88A70,#F03C16,#F88A70,transparent);margin:0;">
    <span leaf=""><br></span>
  </section>
</section>
```
...
<section style="margin-top:48px;margin-bottom:28px;padding:0 10px;">
  <section style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;padding-bottom:14px;border-bottom:3px solid #F03C16;">
    <section style="display:flex;align-items:center;">
      <span style="display:inline-block;background:#F03C16;color:#FFFFFF;font-size:18px;font-weight:900;padding:4px 14px;border-radius:6px;margin-right:14px;line-height:1.3;"><span leaf="">01</span></span>
      <section>
        <p style="font-size:10px;color:#F03C16;font-weight:700;letter-spacing:3px;margin:0 0 2px;text-transform:uppercase;">
...
```html
<span style="display:inline-block;background:#F03C16;color:#FFFFFF;font-size:18px;font-weight:900;padding:4px 14px;border-radius:6px;margin-right:14px;line-height:1.3;"><span leaf="">∞</span></span>
```
...
<p style="margin-bottom:20px;font-size:15px;line-height:1.8;text-align:justify;">
  <span leaf="">{{前半句}}</span>
  <span style="border-bottom:2px solid #F8C1B5;font-weight:600;"><span leaf="">{{需要强调的关键短语}}</span></span>
  <span leaf="">{{后半句}}</span>
</p>
```
...
```html
<p style="font-size:15px;font-weight:800;color:#1C1917;margin:28px 0 14px;padding-left:10px;border-left:3px solid #F03C16;line-height:1.4;">
  <span leaf="">{{子标题}}</span>
</p>
```
...
```html
<strong style="color:#F03C16;"><span leaf="">红色加粗锚点</span></strong>
```

### 7b. 浅红底深红字标签（核心概念，每篇 2~4 个）

```html
<span style="background:#FDE5DF;color:#B62727;padding:2px 6px;border-radius:3px;font-weight:700;"><span leaf="">关键词标签</span></span>
```

### 7c. 浅红背景高亮（次要关键词）

```html
<span style="background:#FDE5DF;padding:1px 6px;border-radius:3px;font-weight:600;color:#B62727;"><span leaf="">浅红背景关键词</span></span>
```

### 7d. 淡粉下划线（最常用，本风格标志性标记）

```html
<span style="border-bottom:2px solid #F8C1B5;font-weight:600;"><span leaf="">淡粉下划线关键词</span></span>
```

### 7e. 荧光笔效果（偶尔用于长句强调）

```html
<span style="background:linear-gradient(180deg,transparent 60%,#F8C1B5 60%);font-weight:700;color:#1C1917;"><span leaf="">荧光笔效果的重要长句</span></span>
```
...
```html
<section style="background:#FFF5F2;border-radius:0 10px 10px 0;border-left:4px solid #F03C16;padding:18px 22px;margin-bottom:24px;">
  <p style="font-size:16px;font-weight:800;color:#B62727;margin:0;line-height:1.8;">
...
```html
<section style="background:#FFF5F2;border-radius:10px;padding:18px 20px;margin-bottom:24px;border:1px solid #F8C1B5;">
...
```html
<p style="font-size:15px;margin:0 0 24px;text-align:center;color:#F03C16;font-weight:700;letter-spacing:1px;border-top:1px solid #FDE5DF;border-bottom:1px solid #FDE5DF;padding:14px 10px;">
  <span leaf="">{{居中金句}}</span>
</p>
```
...
```html
<section style="background:#FFF5F2;border-left:4px solid #F03C16;border-radius:0 8px 8px 0;padding:14px 20px;margin-bottom:24px;">
  <p style="font-size:14px;font-weight:700;color:#B62727;margin:0;line-height:1.8;">
...
<section style="padding:6px 0 4px;margin-bottom:16px;">
  <p style="margin-bottom:6px;font-size:12px;font-weight:700;color:#9CA3AF;letter-spacing:1px;">
    <span style="color:#F03C16;"><span leaf="">！踩坑提示 🕳</span></span>
  </p>
...
<section style="margin-bottom:22px;">
  <section style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
    <span style="display:inline-block;background:#F03C16;color:#fff;font-size:11px;font-weight:700;padding:2px 8px;border-radius:4px;"><span leaf="">STEP 01</span></span>
...
`STEP 01` 可替换为 `SKILL 1`、`TOOL 摄像机`、`CASE 01`（盘点/案例场景）；盘点场景标签底色可改灰 `#E5E7EB`+字 `#B62727` 做次级层次。
...
<section style="margin-bottom:24px;">
  <section style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
    <span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#F03C16;color:#fff;font-size:12px;font-weight:700;border-radius:50%;flex-shrink:0;margin-top:2px;"><span leaf="">1</span></span>
    <p style="font-size:15px;color:#374151;margin:0;line-height:1.8;flex:1;"><span leaf="">{{列表项内容}}</span></p>
  </section>
  <section style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
    <span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#F03C16;color:#fff;font-size:12px;font-weight:700;border-radius:50%;flex-shrink:0;margin-top:2px;"><span leaf="">2</span></span>
    <p style="font-size:15px;color:#374151;margin:0;line-height:1.8;flex:1;"><span leaf="">{{列表项内容}}</span></p>
  </section>
  <section style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
    <span style="display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;background:#F03C16;color:#fff;font-size:12px;font-weight:700;border-radius:50%;flex-shrink:0;margin-top:2px;"><span leaf="">3</span></span>
    <p style="font-size:15px;color:#374151;margin:0;line-height:1.8;flex:1;"><span leaf="">{{列表项内容}}</span></p>
  </section>
</section>
```
...
<section style="margin-bottom:14px;">
  <p style="margin:0 0 6px;">
    <span style="display:inline-block;font-size:14px;font-weight:700;color:#B62727;background:#FDE5DF;padding:3px 10px;border-radius:999px;"><span style="display:inline-block;width:6px;height:6px;background:#F03C16;border-radius:50%;margin-right:5px;vertical-align:middle;"><span leaf=""><br></span></span><span leaf="">{{要点标题}}</span></span>
  </p>
...
<section style="display:flex;margin-bottom:24px;">
  <section style="display:flex;flex-direction:column;align-items:center;margin-right:16px;flex-shrink:0;">
    <section style="width:14px;height:14px;border-radius:50%;border:3px solid #F03C16;background:#fff;margin-top:4px;"><span leaf=""><br></span></section>
    <section style="width:2px;background:#FDE5DF;flex:1;margin-top:4px;min-height:44px;"><span leaf=""><br></span></section>
  </section>
...
<section style="display:flex;margin-bottom:24px;padding:0;">
  <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:18px 16px;margin-right:8px;text-align:center;border:1px solid #FDE5DF;">
    <p style="font-size:28px;font-weight:900;color:#F03C16;margin:0 0 4px;line-height:1;"><span leaf="">{{数字}}</span></p>
    <p style="font-size:12px;color:#9CA3AF;margin:0;"><span leaf="">{{说明}}</span></p>
  </section>
  <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:18px 16px;text-align:center;border:1px solid #FDE5DF;">
    <p style="font-size:28px;font-weight:900;color:#F03C16;margin:0 0 4px;line-height:1;"><span leaf="">{{数字}}</span></p>
    <p style="font-size:12px;color:#9CA3AF;margin:0;"><span leaf="">{{说明}}</span></p>
  </section>
</section>
...
```html
<section style="display:flex;margin-bottom:24px;padding:0;">
  <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:16px 10px;margin-right:8px;text-align:center;border:1px solid #FDE5DF;">
    <p style="font-size:24px;font-weight:900;color:#F03C16;margin:0 0 4px;line-height:1;"><span leaf="">{{数字}}</span></p>
  ...
  <section style="flex:1;background:#FFF5F2;border-radius:10px;padding:16px 10px;text-align:center;border:1px solid #FDE5DF;">
    <p style="font-size:24px;font-weight:900;color:#F03C16;margin:0 0 4px;line-height:1;"><span leaf="">{{数字}}</span></p>
    <p style="font-size:11px;color:#9CA3AF;margin:0;"><span leaf="">{{说明}}</span></p>
  </section>
</section>
...
<section style="margin-bottom:24px;overflow-x:auto;">
  <table style="width:100%;border-collapse:collapse;font-size:14px;">
    <thead>
      <tr>
        <th style="background:#F03C16;color:#fff;font-weight:700;padding:8px 12px;text-align:left;"><span leaf="">{{列标题}}</span></th>
        <th style="background:#F03C16;color:#fff;font-weight:700;padding:8px 12px;text-align:left;"><span leaf="">{{列标题}}</span></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="padding:8px 12px;border-bottom:1px solid #FDE5DF;color:#374151;"><span leaf="">{{内容}}</span></td>
        <td style="padding:8px 12px;border-bottom:1px solid #FDE5DF;color:#374151;"><span leaf="">{{内容}}</span></td>
      </tr>
      <tr>
        <td style="padding:8px 12px;border-bottom:1px solid #FDE5DF;color:#374151;background:#FFF5F2;"><span leaf="">{{内容}}</span></td>
        <td style="padding:8px 12px;border-bottom:1px solid #FDE5DF;color:#374151;background:#FFF5F2;"><span leaf="">{{内容}}</span></td>
      </tr>
    </tbody>
  </table>
...
```html
<span style="display:inline-block;background:#FDE5DF;color:#B62727;font-size:12px;font-weight:700;padding:2px 10px;border-radius:4px;margin-right:6px;"><span leaf="">标签名</span></span>
```

红色描边（轻量）：

```html
<span style="display:inline-block;border:1px solid #F03C16;color:#F03C16;font-size:12px;font-weight:600;padding:1px 10px;border-radius:4px;margin-right:6px;"><span leaf="">标签名</span></span>
```
...
多行代码块用通用增量库 `common-components.md` 的 1a 深色 / 1b 浅色（左竖条换 `#F03C16`），禁 `white-space:pre`。
...
<section style="padding:0 10px;">
  <section style="text-align:center;margin:0 0 32px;">
    <section style="display:flex;align-items:center;justify-content:center;">
      <span style="height:2px;width:60px;background:linear-gradient(to right,transparent,#F03C16);margin-right:12px;"><span leaf=""><br></span></span>
      <span style="font-size:11px;color:#F03C16;letter-spacing:3px;font-weight:700;"><span leaf="">END</span></span>
      <span style="height:2px;width:60px;background:linear-gradient(to left,transparent,#F03C16);margin-left:12px;"><span leaf=""><br></span></span>
    </section>
  </section>
</section>
```
...
<section style="padding:0 10px;">
  ...
  <p style="margin-bottom:20px;font-size:15px;line-height:1.8;text-align:justify;">
    ...
    <strong style="color:#F03C16;"><span leaf="">点赞、在看、转发</span></strong>
...
<section style="max-width:677px;margin:0 auto;background:#ffffff;font-family:-apple-system,BlinkMacSystemFont,'PingFang SC','Hiragino Sans GB','Microsoft YaHei',sans-serif;color:#374151;line-height:1.75;letter-spacing:0.5px;overflow-x:hidden;">
  ...
  <!-- 7. 公司二维码 CTA（通用组件 company-qr-cta，全文唯一） -->
...
**骨架铁律**：引言卡在最前；导读区在前言正文之后、第一章之前；章节之间用组件 4 红色渐变线分隔；二维码在结语后、END 前；一篇只有一个二维码 + 一个 END + 一个签名区。
...
**克制原则**：
- 红底白字标签（`bg:#F03C16`）**仅在引言卡内**，正文关键词标签用浅红底深红字 7b
- 红色加粗全文 ≤5 处
...
| ` ``` 多行代码块 ``` ` | 通用库 1a 深色 / 1b 浅色（左竖条换 #F03C16） | 每行一个 `<p style="margin:0">` |
